...
const companyPageHeader = props => (
    <div className='companyPageHeaderContainer'>
        <div className='companyPageLeftRow'>
            <span className='companyPageHeaderPic'>
                <img src={CompanyPagePic} />
            </span>
        </div>
        <div className='companyPageRightRow'>
            ...
            <span className='companyPageHeaderText-2'>
                Teknologi, kompetansebygging {/* props.subtext */}
            </span>
