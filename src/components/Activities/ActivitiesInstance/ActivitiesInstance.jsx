...
export default class extends React.Component {
  ...
  render(){
    ...
    const date = this.formatDate(this.props.start_date, this.props.end_date, this.props.frequency);
    const time = this.formatTime(this.props.start_time, this.props.end_time);
    const chip_time_stamp = this.formatTimeStamp(this.props.start_date, this.props.start_time);
